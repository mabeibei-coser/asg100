...
// 语义对照 A200：A200 是余额制(creditCents→到账余额)，asg100 是时间制(durationDays→VIP 时长)。

/** @typedef {{ id: string, label: string, amountCents: number, durationDays: number, badge: string|null }} Package */
