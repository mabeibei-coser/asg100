...
> 会员中心(asg100) + 隐患识别(A600改造版) + 安防文档库(A800) 一起上线。
> 网址：会员中心 `/asg100/`、识别 `/a600/`、文档库 `/a800/`，同域 `h100.jsai100.com`。
> 服务器：腾讯云 124.222.114.47，端口 asg100=4002 / A600=4001 / A800=4003。
...
- A600/A800 额外：`ASG_CENTER_BASE_URL=http://127.0.0.1:4002` + `VITE_CENTER_URL=https://h100.jsai100.com/asg100/`
