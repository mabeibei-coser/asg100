...
const BENEFITS = [
  { icon: <FileDownloadOutlinedIcon sx={{ fontSize: 18 }} />, title: '隐患台账一键导出', desc: '最近识别清单导出 Excel，含现场照片' },
  { icon: <LibraryBooksOutlinedIcon sx={{ fontSize: 18 }} />, title: '全部安防文档无限下载', desc: '安全规范 / 应急预案 / 检查表 / 岗位文档' },
  { icon: <HistoryIcon sx={{ fontSize: 18 }} />, title: '识别历史完整回看', desc: '历次识别结果与隐患清单随时翻查' },
  { icon: <FactCheckOutlinedIcon sx={{ fontSize: 18 }} />, title: 'AI 按 36 项专业清单识别', desc: '消防 / 电气 / 高处 / 机械等场景全覆盖' },
];
